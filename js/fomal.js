...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | zhangdajio🐾")[0];
}
...
function createtime1() {
  ...
  var ascll = [
    ...
    `
       ...
       .__                              .___           __.__
_______|  |__ _____    ____    ____   __| _/____      |__|__| ____
\___   /  |  \\__  \  /    \  / ___\ / __ |\__  \     |  |  |/  _ \
 /    /|   Y  \/ __ \|   |  \/ /_/  > /_/ | / __ \_   |  |  (  <_> )
/_____ \___|  (____  /___|  /\___  /\____ |(____  /\__|  |__|\____/
      \/    \/     \/     \//_____/      \/     \/\______|
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by zhangdajio🐾 %c 你正在访问zhangdajio🐾の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| zhangdajio🐾") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('zhangdajio🐾的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if ((y == 2024 && m == 12 && dd == 21) || (y == 2025 && m == 12 && dd == 21)) {//冬至
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("冬至快乐\n快吃上一碗热热的汤圆和饺子吧🧆");
    sessionStorage.setItem("isPopupWindow", "1");
  }
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("12/12/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='../image/blog/floot1.png' title='别往下拉了，没有啦~' width=100px><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://s2.loli.net/2025/01/03/IXUns2vq7imATlM.jpg' title='夜深了，要注意休息啊(*^▽^*)' width=100px><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
// 更换背景(自己的代码),路径是从主体的source开始
if (localStorage.getItem("blogbg") != undefined) {
  setBg(localStorage.getItem("blogbg"));
} else {
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/img/back1.png);
    --darkmode-bg:url(https://lskypro.acozycotage.net/zhangdajio/img/yuanshen1.webp);
    --mobileday-bg: url(https://lskypro.acozycotage.net/zhangdajio/img/snow.webp);
    --mobilenight-bg: url(https://lskypro.acozycotage.net/zhangdajio/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<h2>二、字体设置</h2>
<div class="note warning modern"><p>非商免字体未经授权只能个人使用。本站为完全非商业、非盈利性质的网站，平时用于个人学习交流，如有侵权请邮件联系站长删除，谢谢！ —— 致版权方</p>
</div>
<p id="swfs">
<a class="swf" id="swf_PF_SanSheng" href="javascript:;" rel="noopener external nofollow" style="font-family:'PF_SanSheng'!important;color:black" onclick="setFont('PF_SanSheng')">平方三生体</a>
<a class="swf" id="swf_PF_XiangSi" href="javascript:;" rel="noopener external nofollow" style="font-family:'PF_XiangSi'!important;color:black" onclick="setFont('PF_XiangSi')">平方相思体</a>
<a class="swf" id="swf_HYTangMeiRen35W" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYTangMeiRen35W'!important;color:black" onclick="setFont('HYTangMeiRen35W')">汉仪唐美人35w</a>
<a class="swf" id="swf_HYTangMeiRen35W" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYTangMeiRen35W'!important;color:black" onclick="setFont('HYTangMeiRen45W')">汉仪唐美人45w</a>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/zhangdajio/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/zhangdajio/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/zhangdajio/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/zhangdajio/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/zhangdajio/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/zhangdajio/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/zhangdajio/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/zhangdajio/img/mb4.webp)')"></a></div>
              </div>
            </details>
